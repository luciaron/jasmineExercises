describe ('calculateMonthlyPayment', function () {
  ...
  it('should return a result with 2 decimal places', function() {
    expect('boop').toBeInstanceOf(String); //no idea why this isn't working. i double-checked the syntax on the documentation for jasmine, and i'm still getting the following:
